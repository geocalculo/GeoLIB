...
// ===============================
// UX Scroll / Zoom control (DESKTOP)
// ===============================
map.scrollWheelZoom.disable();   // ❌ rueda NO hace zoom
map.touchZoom.enable();          // ✅ pinch zoom (mobile)
map.dragging.enable();           // ✅ click + drag
map.doubleClickZoom.enable();    // opcional

// Zoom solo con Ctrl + scroll (trackpad / mouse)
